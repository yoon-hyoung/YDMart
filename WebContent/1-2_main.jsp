...
<!DOCTYPE HTML5>
<html>
    <title>TANGIRINE/HANRABONG</title>
    <meta charset="UTF-8">
                    ...
                    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat">
                        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
                            ...
                            <body class="w3-content" style="max-width:1200px">
                            	<form action="item_detail.jsp" method = "post" >      
                                 <%//get ID value
                                ...
                                <nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:300px" id="mySidebar">
                                    <div class="w3-container w3-display-container w3-padding-16">
                                        ...
                                        for(int i = 0; i < 3; i++){
                                        	...
                                        	for(int j = 0; j < 3; j++) {
                                        		if(i == 1 && j == 2){
                                        			out.println("<a href='"+(i+1)+"-"+(j+1)+"_main.jsp' class='w3-bar-item w3-button" 
                                        					+"w3-light-grey'><i class='fa fa-caret-right w3-margin-right'>"+sub[i][j]+"</i></a>");
                                        		}
                                    ...
                                    <a href="changepw_input.jsp" class="w3-bar-item w3-button w3-padding" >Change Password</a>
                                   ...
                                   <header class="w3-container w3-xlarge">
                                    ...
                                    <div class="w3-container w3-black w3-padding-32">
                                        ...
                                        <tr>
                                            ...
                                            <%
                                            sql = "select NAME, PRICE, I_NUM from ITEM WHERE CATEGORY = 1 AND SUB_CAT = 2";
                                            stmt = con.createStatement();
                                            rs = stmt.executeQuery(sql);
                            				while(rs.next()) {
