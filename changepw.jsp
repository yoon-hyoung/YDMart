...
String url = "jdbc:mysql://localhost:3306/SYDMART?serverTimezone = UTC";
	...
	if(pw1.equals("") || pw1 == null || pw2.equals("") || pw2 == null) {
		out.println("<script>alert('Input new password'); location.href='changepw_input.jsp'</script>");

	}
	if(!pw1.equals(pw2)) {
		out.println("<script>alert('Password not match'); location.href='changepw_input.jsp'</script>");
	}
